...
std::string openBaseString = "omnidirection_car";
...
omnidirection_car::KinematicsForward service;

ros::Time timeCurrent;
ros::Time timePrevious;

void onEncoderMessage(const omnidirection_car::Velocity::ConstPtr& input){
...
int main(int argc, char **argv){
    ...
    kinematicsForwardWorld  = node.serviceClient<omnidirection_car::KinematicsForward>("kinematics_forward_world" );
    kinematicsForwardMobile = node.serviceClient<omnidirection_car::KinematicsForward>("kinematics_forward_mobile");
