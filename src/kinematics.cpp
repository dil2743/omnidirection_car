...
#include <omnidirection_car/KinematicsForward.h>
...
bool mobileToWorld(omnidirection_car::FrameToFrame::Request &request, omnidirection_car::FrameToFrame::Response &response) {
...
bool worldToMobile(omnidirection_car::FrameToFrame::Request &request, omnidirection_car::FrameToFrame::Response &response) {
    worldToMobileCore(request.input.x, request.input.y, response.output.x, response.output.y);
}

bool forwardMobile(omnidirection_car::KinematicsForward::Request &request, omnidirection_car::KinematicsForward::Response &response) {
...
bool forwardWorld(omnidirection_car::KinematicsForward::Request &request, omnidirection_car::KinematicsForward::Response &response) {
    forwardMobile(request, response);
    mobileToWorldCore(response.output.x, response.output.y, response.output.x, response.output.y);
    return true;
}

bool inverseMobile(omnidirection_car::KinematicsInverse::Request &request, omnidirection_car::KinematicsInverse::Response &response) {
...
bool inverseWorld(omnidirection_car::KinematicsInverse::Request &request, omnidirection_car::KinematicsInverse::Response &response) {
